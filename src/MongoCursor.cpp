...
//        }
       ...
       //query_bs = encodeToBSON(query);
       encodeToBSONNew(query,&query_bs);
...
//        }
//        if (flags_array->exists((int64_t) 1)) {
//            flags = (flags | MONGOC_QUERY_TAILABLE_CURSOR);
//        }
//        if (flags_array->exists((int64_t) 2)) {
//            flags = (flags | MONGOC_QUERY_SLAVE_OK);
//        }
//        if (flags_array->exists((int64_t) 3)) {
//            flags = (flags | MONGOC_QUERY_OPLOG_REPLAY);
//        }
//        if (flags_array->exists((int64_t) 4)) {
//            flags = (flags | MONGOC_QUERY_NO_CURSOR_TIMEOUT);
//        }
//        if (flags_array->exists((int64_t) 5)) {
//            flags = (flags | MONGOC_QUERY_AWAIT_DATA);
//        }
//        if (flags_array->exists((int64_t) 6)) {
//            flags = (flags | MONGOC_QUERY_EXHAUST);
//        }
//        if (flags_array->exists((int64_t) 7)) {
//            flags = (flags | MONGOC_QUERY_PARTIAL);
//        }
        ...
        encodeToBSONNew(read_pref_tagsets,&read_prefs_tags_bs);
        /*
...
//        bson_append_bool(&fields_bs, "_id", -1, false);
//        bson_append_bool(&fields_bs, "ctime", -1, true);
//        bson_append_bool(&fields_bs, "author", -1, true);
//        bson_append_bool(&fields_bs, "com_id", -1, true);
//        bson_append_bool(&fields_bs, "city_name", -1, true);

   
         //fields_bs = encodeToBSON(fields);
         encodeToBSONNew(fields,&fields_bs);
         //encodeToBSONNew(fields,&fields_bs);
        //bson_init(&fields_bs);
        //fillBSONWithArray(fields,&fields_bs);
//        
//        
//        for (ArrayIter iter(((Variant)fields).toArray()); iter; ++iter) {
//            Variant key(iter.first());
//            const Variant& data(iter.secondRef());
//            printf("%s\r\n",key.toString().c_str());
//            variantToBSON(data, key.toString().c_str(), &fields_bs);
//            //bson_append_bool(&fields_bs, key.toString().c_str(), -1, data.toBoolean());
//            
//        }
